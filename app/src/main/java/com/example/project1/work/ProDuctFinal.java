...
import com.example.project1.Adapter.ProductFinal.ProductFinalAdapter;
...
public class ProDuctFinal extends AppCompatActivity {
    Toolbar toolbar;
    ActionBar actionBar;
    RecyclerView recyclerView;
    ProductFinalAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar = (Toolbar) findViewById(R.id.toolbarproductfinal);
        actionBar= getSupportActionBar();
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        recyclerView = findViewById(R.id.rcv_productfinal);
        RecyclerView.LayoutManager manager = new LinearLayoutManager(this);
        recyclerView.setLayoutManager(manager);
        productModels = new ArrayList<>();
        getpayment(Main.iduser);
        toolbar.setTitle("Sản Phẩm Đã Mua");
    }
    ...
    private void getorderdetail(String idorder)
    {
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                {
                    DataSnapshot next = iterator.next();
                    com.example.project1.Model.OrderDetail model = next.getValue(OrderDetail.class);
    ...
    private void getproduct(String idproduct)
    {
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                adapter = new ProductFinalAdapter(ProDuctFinal.this,productModels);
