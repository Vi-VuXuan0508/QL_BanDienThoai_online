...
public class ProDuctXiaomiAdapter extends RecyclerView.Adapter<ProDuctXiaomiAdapter.ViewHolder> {
    Activity context;
    ArrayList<ProductModel> productModels;
    DatabaseReference database = FirebaseDatabase.getInstance().getReference();
    public ProDuctXiaomiAdapter(Activity context, ArrayList<ProductModel> productModels) {
