...
public class ProDuctSamSumAdapter extends RecyclerView.Adapter<ProDuctSamSumAdapter.ViewHolder> {
    Activity context;
    ArrayList<ProductModel> productModels;
    DatabaseReference database = FirebaseDatabase.getInstance().getReference();
    public ProDuctSamSumAdapter(Activity context, ArrayList<ProductModel> productModels) {
