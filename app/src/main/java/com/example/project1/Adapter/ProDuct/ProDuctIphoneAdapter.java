...
public class ProDuctIphoneAdapter extends RecyclerView.Adapter<ProDuctIphoneAdapter.ViewHolder> {
    Activity context;
    ArrayList<ProductModel> productModels;
    ArrayList<ProductInformation> productInformations = new ArrayList<>();
    DatabaseReference database = FirebaseDatabase.getInstance().getReference();
    public ProDuctIphoneAdapter(Activity context, ArrayList<ProductModel> productModels) {
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                while (iterator.hasNext())
                {
                    ...
                    Log.i("fesafesa","Screen: "+information.getScreen()+" Camera: "+information.getCamera()+" Camera Selfie: "+information.getCameraselfie()+" CPU: "+information.getCpu()+" Ram: " +information.getRam()+" Rom: "+information.getRom());
                }
            }
