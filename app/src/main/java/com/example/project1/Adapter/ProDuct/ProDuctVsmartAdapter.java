...
public class ProDuctVsmartAdapter extends RecyclerView.Adapter<ProDuctVsmartAdapter.ViewHolder> {
    Activity context;
    ArrayList<ProductModel> productModels;
    DatabaseReference database = FirebaseDatabase.getInstance().getReference();
    public ProDuctVsmartAdapter(Activity context, ArrayList<ProductModel> productModels) {
