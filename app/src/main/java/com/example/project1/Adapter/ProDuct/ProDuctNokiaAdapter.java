...
public class ProDuctNokiaAdapter extends RecyclerView.Adapter<ProDuctNokiaAdapter.ViewHolder> {
    Activity context;
    ArrayList<ProductModel> productModels;
    DatabaseReference database = FirebaseDatabase.getInstance().getReference();
    public ProDuctNokiaAdapter(Activity context, ArrayList<ProductModel> productModels) {
