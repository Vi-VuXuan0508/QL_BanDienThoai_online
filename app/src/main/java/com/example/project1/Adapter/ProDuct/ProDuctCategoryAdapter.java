...
public class ProDuctCategoryAdapter extends RecyclerView.Adapter<ProDuctCategoryAdapter.ViewHolder> {
    ...
    ArrayList<ProductModel> productModelsFilter;
    public ProDuctCategoryAdapter(Activity context, ArrayList<ProductModel> productModels) {
        this.context = context;
        this.productModels = productModels;
        this.productModelsFilter = new ArrayList<>(productModels);
    }
    ...
    private Filter filter = new Filter() {
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            ...
            {
                filter.addAll(productModelsFilter);
            }
            else
            {
                for (ProductModel model: productModelsFilter)
                {
        ...
        protected void publishResults(CharSequence constraint, FilterResults results) {
            productModelsFilter = (ArrayList<ProductModel>) results.values;
